...
const MOCK_VENTURES = [
  {
    ...
    equity: "5%",
    fundingGoal: "$50,000",
    traction: "1,200+ active users, 92% retention rate, 3 school pilots signed",
  ...
  },
  {
    ...
    equity: "8%",
    fundingGoal: "$25,000",
    traction: "500+ beta signups, 4.6★ App Store rating",
    fundingStage: "Pre-seed",
  ...
  },
  {
    ...
    equity: "12%",
    fundingGoal: "$150,000",
    traction: "Prototype completed, 3 clinical advisors onboard, IRB approval pending",
    fundingStage: "Seed",
  ...
  },
  {
    ...
    equity: "4%",
    fundingGoal: "$200,000",
    traction: "$10k Monthly Revenue, 3 campuses live, 200+ active couriers",
    fundingStage: "Seed",
